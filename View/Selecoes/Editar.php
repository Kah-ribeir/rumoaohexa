...
<form method="post">
    ...
    <label>Nome:</label>
    <input type="text" name="nome" value="<?=$selecoes['nome'];?>" required>

    <label>Grupo:</label>
    <input type="text" name="grupo" value="<?=$selecoes['grupo'];?>" required>

    <label>Continente:</label>
    <input type="text" name="continente" value="<?=$selecoes['continente'];?>" required>
